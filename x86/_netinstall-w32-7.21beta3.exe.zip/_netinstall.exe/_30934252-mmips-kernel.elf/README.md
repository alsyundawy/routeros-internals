### 30934252-mmips-kernel.elf
#### Identification (`file <*>`):
```
ELF 32-bit LSB executable, MIPS, MIPS32 rel2 version 1 (SYSV), statically linked, BuildID[sha1]=288c1624b39d6fe6f23c521eba1910e8eeba4a38, stripped
```
#### Analysis (`binwalk <*>`):
```
...
/:
total 1228
-rw-r--r-- 1 root root   10047 2025-10-16 16:37:51.431789859 +0100 4a1fc0.dtb
-rw-r--r-- 1 root root     492 2025-10-16 16:37:51.406789870 +0100 4a5368.cpio
-rw-r--r-- 1 root root 1248256 2025-10-16 16:37:52.033789603 +0100 4aca41.cpio
```
